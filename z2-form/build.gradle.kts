...
val z2_material_version: String by project
val z2_schema_version: String by project
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                api("hu.simplexion.z2:z2-material:${z2_material_version}")
                api("hu.simplexion.z2:z2-schema:${z2_schema_version}")
            }
        }
    }
}
